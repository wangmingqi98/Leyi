...
public class GestureUnlockView extends View {
    ...
    private Paint circleInsidePaints;
    ...
    private String curText = "请输入手势密码";
    ...
    public GestureUnlockView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        circleInsidePaints = new Paint();
        circleInsidePaints.setAntiAlias(true);
        circleInsidePaints.setColor(Color.RED);
        circleInsidePaints.setStyle(Paint.Style.FILL);
    ...
    public interface OnUnlockListener {
         ...
         */
        public int onUnlockFinished(ArrayList<Integer> password);
    }
