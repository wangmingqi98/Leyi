...
public class SetPayPwdBean {
    ...
    public static SetPayPwdBean objectFromData(String str) {

        return new Gson().fromJson(str, SetPayPwdBean.class);
    }


        /**
         * show_err : 修改成功
         * user_info : {"user_id":758,"user_name":"安慕希","user_img":"","user_mobile":"132****3695","id_passed":0,"has_paypassword":1,"binded_card":[]}
         */
