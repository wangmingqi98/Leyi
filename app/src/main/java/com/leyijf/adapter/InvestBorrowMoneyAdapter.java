...
public class InvestBorrowMoneyAdapter extends BaseQuickAdapter<MyBorrowMoneyBean.ItemBean,BaseViewHolder> {
    private List<MyBorrowMoneyBean.ItemBean> item;

    public InvestBorrowMoneyAdapter(int layoutResId, @Nullable List<MyBorrowMoneyBean.ItemBean> data) {
