...
public class B_RepaymentAdapter extends BaseQuickAdapter<MyBorrowMoneyBean.ItemBean,BaseViewHolder> {
    private List<MyBorrowMoneyBean.ItemBean> item;
    public B_RepaymentAdapter(int layoutResId, @Nullable List<MyBorrowMoneyBean.ItemBean> data) {
