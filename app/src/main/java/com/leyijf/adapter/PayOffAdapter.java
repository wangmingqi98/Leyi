...
public class PayOffAdapter extends BaseQuickAdapter<MyInvestBean.ItemBean,BaseViewHolder> {
    private List<MyInvestBean.ItemBean> item;

    public PayOffAdapter(int layoutResId, @Nullable List<MyInvestBean.ItemBean> data) {
