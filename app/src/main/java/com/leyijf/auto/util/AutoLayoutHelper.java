...
import com.leyijf.R;
import com.leyijf.auto.layout.AutoLayoutInfo;
import com.leyijf.auto.layout.attr.HeightAttr;
import com.leyijf.auto.layout.attr.MarginAttr;
import com.leyijf.auto.layout.attr.MarginBottomAttr;
import com.leyijf.auto.layout.attr.MarginLeftAttr;
import com.leyijf.auto.layout.attr.MarginRightAttr;
import com.leyijf.auto.layout.attr.MarginTopAttr;
import com.leyijf.auto.layout.attr.MaxHeightAttr;
import com.leyijf.auto.layout.attr.MaxWidthAttr;
import com.leyijf.auto.layout.attr.MinHeightAttr;
import com.leyijf.auto.layout.attr.MinWidthAttr;
import com.leyijf.auto.layout.attr.PaddingAttr;
import com.leyijf.auto.layout.attr.PaddingBottomAttr;
import com.leyijf.auto.layout.attr.PaddingLeftAttr;
import com.leyijf.auto.layout.attr.PaddingRightAttr;
import com.leyijf.auto.layout.attr.PaddingTopAttr;
import com.leyijf.auto.layout.attr.TextSizeAttr;
import com.leyijf.auto.layout.attr.WidthAttr;
import com.leyijf.auto.layout.config.AutoLayoutConifg;
...
public class AutoLayoutHelper {
	...
	public void adjustChildren() {
		...
		for (int i = 0, n = mHost.getChildCount(); i < n; i++) {
			...
			if (params instanceof AutoLayoutParams) {
				AutoLayoutInfo info = ((AutoLayoutParams) params)
						.getAutoLayoutInfo();
				if (info != null) {
					info.fillAttrs(view);
				}
	...
	public static AutoLayoutInfo getAutoLayoutInfo(Context context,
		...
		int baseWidth = a.getInt(
				R.styleable.AutoLayout_Layout_layout_auto_basewidth, 0);
		int baseHeight = a.getInt(
				R.styleable.AutoLayout_Layout_layout_auto_baseheight, 0);
		a.recycle();
		...
		for (int i = 0; i < n; i++) {
			...
			case INDEX_MAX_WIDTH:
				info.addAttr(new MaxWidthAttr
						(pxVal, baseWidth, baseHeight));
				break;
	...
	private static int getComplexUnit(int data) {
		return TypedValue.COMPLEX_UNIT_MASK
				& (data >> TypedValue.COMPLEX_UNIT_SHIFT);
	}
