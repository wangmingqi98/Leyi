package com.leyijf.auto.layout.widget;
...
import com.leyijf.auto.util.AutoLayoutHelper;
import com.leyijf.auto.util.AutoUtils;
...
public class MetroLayout extends ViewGroup {
	...
	public MetroLayout(Context context, AttributeSet attrs) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.MetroLayout);
		mDivider = a.getDimensionPixelOffset(
				R.styleable.MetroLayout_metro_divider, 0);
	...
	private void randomColor() {
		...
		for (int i = 0, n = getChildCount(); i < n; i++) {
			...
			v.setBackgroundColor(Color.argb(100, r.nextInt(), r.nextInt(),
					r.nextInt()));
		}
	}
