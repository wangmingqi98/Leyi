...
import com.leyijf.adapter.B_RepaymentAdapter;
...
public class RepaymentFragment extends BaseFragment {
    public static final String TAG = "RepaymentFragment";
    ...
    private B_RepaymentAdapter adapter;
    ...
    protected void initView(View view) {
        ...
        adapter = new B_RepaymentAdapter(R.layout.item_borrowmoney,item);
    ...
    private void initFlowStandard() {
        ...
        observable.compose(compose(RepaymentFragment.this.bindToLifecycle())).subscribe(new BaseObserver<MyBorrowMoneyBean>(getActivity()) {
            @Override
