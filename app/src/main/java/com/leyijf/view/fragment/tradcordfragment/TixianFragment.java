...
public class TixianFragment extends BaseFragment {
    public static final String TAG = "TixianFragment";
    ...
    private void initTradingrecord() {
        ...
        observable.compose(compose(TixianFragment.this.bindToLifecycle())).subscribe(new BaseObserver<TransactionRecordsBean>(getActivity()) {
