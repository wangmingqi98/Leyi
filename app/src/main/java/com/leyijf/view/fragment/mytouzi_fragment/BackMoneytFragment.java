...
import com.leyijf.adapter.RepaymentAdapter;
...
public class BackMoneytFragment extends BaseFragment {
    public static final String TAG = "BackMoneytFragment";
    ...
    private void initInvest() {
        ...
        observable.compose(compose(BackMoneytFragment.this.bindToLifecycle())).subscribe(new BaseObserver<MyInvestBean>(getActivity()) {
            @Override
            protected void onHandleSuccess(MyInvestBean myInvestBean) {
                ...
                adapter = new RepaymentAdapter(R.layout.mytouzi_item, item);
