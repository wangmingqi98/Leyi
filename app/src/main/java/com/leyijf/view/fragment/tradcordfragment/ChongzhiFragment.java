...
public class ChongzhiFragment extends BaseFragment {
    public static final String TAG = "ChongzhiFragment";
    ...
    private void initTradingrecord() {
        ...
        observable.compose(compose(ChongzhiFragment.this.bindToLifecycle())).subscribe(new BaseObserver<TransactionRecordsBean>(getActivity()) {
