...
public class NewsAdapter extends FragmentPagerAdapter {
    ...
    private List<RepaymentClasificationBean.CateInfoBean> tabs;
    List<Fragment> fragments;
    Context context;


    public NewsAdapter(FragmentManager fm,  List<RepaymentClasificationBean.CateInfoBean> tabs, List<Fragment> fragments, Context context) {
        super(fm);
        this.tabs = tabs;
...
//        sp.setSpan(imageSpan, 0, 1, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        Log.d("tabs", "getPageTitle: "+tabs.get(position).getName());
