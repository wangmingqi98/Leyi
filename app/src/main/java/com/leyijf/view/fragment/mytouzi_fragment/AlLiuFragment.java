...
import com.leyijf.adapter.FlowStandardAdapter;
...
public class AlLiuFragment extends BaseFragment {
    public static final String TAG = "AlLiuFragment";
    ...
    private FlowStandardAdapter adapter;
    ...
    private void initInvest() {
        ...
        observable.compose(compose(AlLiuFragment.this.bindToLifecycle())).subscribe(new BaseObserver<MyInvestBean>(getActivity()) {
            @Override
            protected void onHandleSuccess(MyInvestBean myInvestBean) {
                if(myInvestBean.getItem()!=null) {
                    ...
                    adapter = new FlowStandardAdapter(R.layout.mytouzi_item, item);
