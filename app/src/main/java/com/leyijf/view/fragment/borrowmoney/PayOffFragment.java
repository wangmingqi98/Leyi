...
import com.leyijf.adapter.BorrowMoneyPayOffAdapter;
...
public class PayOffFragment extends BaseFragment {
    public static final String TAG = "PayOffFragment";
    ...
    private BorrowMoneyPayOffAdapter adapter;
    ...
    protected void initView(View view) {
        ...
        adapter = new BorrowMoneyPayOffAdapter(R.layout.item_borrowmoney,item);
    ...
    private void initFlowStandard() {
        ...
        observable.compose(compose(PayOffFragment.this.bindToLifecycle())).subscribe(new BaseObserver<MyBorrowMoneyBean>(getActivity()) {
            @Override
