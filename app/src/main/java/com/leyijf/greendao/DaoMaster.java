...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        BindedCardBeanDao.createTable(db, ifNotExists);
        FeeConfigBeanDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        BindedCardBeanDao.dropTable(db, ifExists);
        FeeConfigBeanDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(BindedCardBeanDao.class);
        registerDaoClass(FeeConfigBeanDao.class);
