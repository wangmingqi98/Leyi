...
public class MyAddYiAdapter extends BaseAdapter {
    Context context;
    List<VoucherBean> list;


    public MyAddYiAdapter(Context context, List<VoucherBean> list) {
    ...
    ViewHolder viewHolder=null;
        if(view==null){
            ...
            view = LayoutInflater.from(context).inflate(R.layout.myadd_carviewitem2, null);
